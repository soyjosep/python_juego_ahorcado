...
def juego_ahorcado():
    ...
    print(f"Tienes {intentos} intentos para adivinar la pantalla secreta")
    ...
    while not juego_terminado and intentos > 0:
        ...
        if len(adivinanza) !=1 or not adivinanza.isalpha():
            print("Por favor introduzca una letra válida(sólo escribrir una letra)")
        ...
        if "_" not in progreso_actual:
            ...
            print(f"¡Felicitaciones has ganado! La palebra completa es: '{palabra_secreta}'")
